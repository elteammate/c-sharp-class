...
public static class Task3
{
     ...
     */
    internal static string FindDigitalSubstring(string s) => throw new NotImplementedException();

    /*
     * Задание 3.4. Заменить все вхождения подстрок строки S, состоящих только из цифр,
     * на заданную строку S1.
     */
    internal static string HideDigits(string s, string s1) => throw new NotImplementedException();
